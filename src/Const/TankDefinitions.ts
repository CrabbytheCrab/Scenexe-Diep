...
export type projectileId = "bullet" | "drone" | "trap" | "necrodrone" | "minion" | "skimmer" | "rocket" | "swarm" | "flame" | "wall" | "croc" | "autotrap";

/** The types of barrel addons that exist in the game */
export type barrelAddonId = "trapLauncher" | "purplebarrel" | "minionSpawner" | "autotrapLauncher";
