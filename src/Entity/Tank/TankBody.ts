...
import { Color, StyleFlags, StatCount, Tank, CameraFlags, Stat, InputFlags, PhysicsFlags, PositionFlags, Body } from "../../Const/Enums";
...
import { BodyDefinition, getBodyById } from "../../Const/BodyDefinitions";
...
export default class TankBody extends LivingEntity implements BarrelBase {
    ...
    public definition: TankDefinition = getTankById(Tank.Node) as TankDefinition;
    public bodydefinition: BodyDefinition = getBodyById(Body.Base) as BodyDefinition;
